...
![Upload VSIX](@assets/img/editor/upload-vsix-extension.png)

Navigate to the _Extensions_ widget in the left sidebar and select _Install from VSIX_ in the options menu.

![Install VSIX step 1](@assets/img/editor/install-vsix-step1.png)
...
![Install VSIX step 2](@assets/img/editor/install-vsix-step2.png)
